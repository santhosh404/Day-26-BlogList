            ...
            <div className='my-20'>
                ...
                <div className='flex flex-col justify-center items-center'>
                    <div className='flex justify-center gap-4 flex-wrap my-10'>
                        {
                            courseList.filter(course => course.tag === "full-stack-development").slice(0, displayCount).map(course => (
                                <CourseCard
                                    key={course.id}
                                    data={course}
                                />
                    ...
                    {displayCount < courseList.filter(course => course.tag === "full-stack-development").length && <CustomButton onClick={handleShowMore}>Show More</CustomButton>}
